...
# python scripts/segmentation_train.py --data_name 'M3D_CAP' --data_dir /media/M3Ddataset/M3D_Cap_npy/ct_quizze/ --out_dir './output/' --image_size 256 --num_channels 128 --class_cond False --num_res_blocks 2 --num_heads 1 --learn_sigma True --use_scale_shift_norm False --attention_resolutions 16 --diffusion_steps 1000 --noise_schedule linear --rescale_learned_sigmas False --rescale_timesteps False --lr 1e-4 --batch_size 4 --version conditioned
